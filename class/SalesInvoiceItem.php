...
class SalesInvoiceItem
{
    ...
    (`invoice_id`, `item_code`, `service_item_code`, `item_name`, `serial_no`, `cost`, `list_price`, `price`, `discount`,`quantity`, `total`, `vehicle_no`, `current_km`, `next_service_date`, `created_at`) 
    VALUES (
        '{$this->invoice_id}', 
        '{$this->item_code}', 
